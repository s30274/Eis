...
hl.bind(altMod .. " + left", hl.dsp.window.move({ direction = "left" }) )
hl.bind(altMod .. " + right", hl.dsp.window.move({ direction = "right" }) )
hl.bind(altMod .. " + up", hl.dsp.window.move({ direction = "up" }) )
hl.bind(altMod .. " + down", hl.dsp.window.move({ direction = "down" }) )
